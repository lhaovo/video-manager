...
mkdir -p /mnt/video-manager-nfs/fn_shared/video_manager/processing
...
ls -la /mnt/video-manager/unprocessed /mnt/video-manager/processing /mnt/video-manager/processed
```
